						...
						<li style="width: 24%">
							<div class="f-movie">
								<div class="f-movie-img">
									<a href="movieDetails.do?id=${fav.movie.id}"><img src="upfile/${fav.movie.filename}" alt=""></a>
								</div>
									<div class="f-movie-name">
										<a href="movieDetails.do?id=${fav.movie.id}">${fav.movie.name}</a>
									</div>								 
								<div class="f-buy-tickets">
									<a href="favDel.do?id=${fav.id}">移出</a>
								</div>
							</div>
						</li>
					</c:forEach>
