...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/movieAdd.do" onsubmit="return supplieradd()">
			    
				
				<div class="layui-form-item">
					<label class="layui-form-label">影片名</label>
					<div class="layui-input-inline">  
					  	<input type="text" name="name" id="name"  lay-verify="required"   style="width: 300px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">  
					  	<input type="date" name="savetime" id="savetime"  lay-verify="required"   style="width: 300px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="zystr" id="zystr"  lay-verify="required" style="width: 600px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					  	<input type="text" name="longtime" id="longtime"  pattern="[1-9]\d*" lay-verify="required" style="width: 600px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">  
					  	<input type="text" name="price" id="price"  lay-verify="required" pattern="(0|[1-9][0-9]{0,9})(\.[0-9]{1,2})?"  style="width: 300px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">  
					    <textarea name="content" style="width: 600px;height: 100px;"   class="layui-textarea" oninvalid="setCustomValidity('视频描述不能为空')" oninput="setCustomValidity('');" ></textarea>
					</div>
				</div>
