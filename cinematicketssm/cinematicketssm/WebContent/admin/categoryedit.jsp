...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/categoryEdit.do" onsubmit="return supplieradd()">
			    <input type="hidden" name="id" value="${category.id}"/>
				
				<div class="layui-form-item">
					<label class="layui-form-label">类别名称</label>
					<div class="layui-input-block">  
					  	<input type="text" name="name" id="name" value="${category.name}" required oninvalid="setCustomValidity('请输入类别名称')" oninput="setCustomValidity('');"  style="width: 300px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
