...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/hallAdd.do" onsubmit="return supplieradd()">
			    
				
				<div class="layui-form-item">
					<label class="layui-form-label">放映厅</label>
					<div class="layui-input-inline">  
					  	<input type="text" name="name" id="name" required oninvalid="setCustomValidity('请输入放映厅')" oninput="setCustomValidity('');"    autocomplete="off"  class="layui-input" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">  
					  	<input type="text" name="seatno" id="seatno"  max="50" required oninvalid="setCustomValidity('格式输入有误')" oninput="setCustomValidity('');"  pattern="[1-9]\d*"   autocomplete="off"  class="layui-input" >
					</div>
				</div>
