			...
			<form class="layui-form col-lg-4" id="supplierform" method="post" action="<%=path %>/admin/productEdit.do" onsubmit="return supplieradd()">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">  
					  	<input type="text" name="name" id="name" value="${product.name }"  lay-verify="required"   style="width: 300px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">  
					  	<input type="text" name="price" id="price" value="${product.price }" lay-verify="required" pattern="(0|[1-9][0-9]{0,9})(\.[0-9]{1,2})?"  style="width: 300px;"  autocomplete="off"  class="layui-input" >
					</div>
				</div>
